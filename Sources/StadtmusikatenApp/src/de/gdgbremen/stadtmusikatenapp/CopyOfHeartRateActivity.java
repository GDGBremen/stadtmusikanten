...
public class CopyOfHeartRateActivity extends Activity{
                            ...
                            int initialDeviceStateCode)
                    {
                        switch(resultCode)
                        {
                            ...
                            case AntPluginMsgDefines.MSG_REQACC_RESULT_whatCHANNELNOTAVAILABLE:
                                Toast.makeText(CopyOfHeartRateActivity.this, "Channel Not Available", Toast.LENGTH_SHORT).show();
                                tv_status.setText("Error. Do Menu->Reset.");
                                break;
                            case AntPluginMsgDefines.MSG_REQACC_RESULT_whatOTHERFAILURE:
                                Toast.makeText(CopyOfHeartRateActivity.this, "RequestAccess failed. See logcat for details.", Toast.LENGTH_SHORT).show();
                                tv_status.setText("Error. Do Menu->Reset.");
                                break;
                            case AntPluginMsgDefines.MSG_REQACC_RESULT_whatDEPENDENCYNOTINSTALLED:
                                tv_status.setText("Error. Do Menu->Reset.");
                                AlertDialog.Builder adlgBldr = new AlertDialog.Builder(CopyOfHeartRateActivity.this);
                                ...
                                adlgBldr.setPositiveButton("Go to Store", new OnClickListener()
                                        {
                                            ...
                                            public void onClick(DialogInterface dialog, int which)
                                            {
                                                ...
                                                CopyOfHeartRateActivity.this.startActivity(startStore);
                                            }
                                        });
                            ...
                            case AntPluginMsgDefines.MSG_REQACC_RESULT_whatUSERCANCELLED:
                                ...
                                break;
                            default:
                                Toast.makeText(CopyOfHeartRateActivity.this, "Unrecognized result: " + resultCode, Toast.LENGTH_SHORT).show();
                                tv_status.setText("Error. Do Menu->Reset.");
                                break;
                        } 
                    }
